...
if __name__ == "__main__":
    ...
    dataMSK12 = pd.read_excel(dataALL_fn, sheet_name='MSK2', index_col=0)#mhj msk12 -> msk2
    ...
    fnIn = '03.Results/6features/PanCancer/PanCancer_all_LLR5noTMB_10k_ParamCalculate.txt' #this was LLR6 so changed
    params_data = open(fnIn, 'r').readlines()
    params_dict = {}
    for line in params_data:
        if 'LLR_' not in line:
